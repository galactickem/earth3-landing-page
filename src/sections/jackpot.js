...
import jackpotImage from 'assets/dashboard.png';
...
const JACKPOT_DATA = [
  {
    image: jackpotImage1,
    text:
      'Simple terms, not confusing nor intimidating.',
    heading: 'Web2 user-friendly',
  },
  {
    image: jackpotImage2,
    text:
      'The best UI for our loyal users.',
    heading: 'Easy to use',
  },
];
        ...
        <Flex sx={styles.flex}>
          ...
          <Box sx={styles.content}>
            <Box sx={styles.heading}>
              ...
              <Heading as="h3">Discover web3 easily</Heading>
            </Box>
